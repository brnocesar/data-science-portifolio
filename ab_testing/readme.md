...
Nosso objetivo aqui é **verificar se a taxa de conversão do grupo AD é maior que o grupo controle (PSA) e se a diferença observada é estatísticamente significativa**.
